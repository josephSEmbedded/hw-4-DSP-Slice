...
HD_PWD='/home/user/hw-4-DSP-Slice/DSP-Slice_HW/DSP-Slice_HW.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adderCLB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adderCLB.tcl
