...
HD_PWD='/home/user/hw-4-DSP-Slice/DSP-Slice_HW/DSP-Slice_HW.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adderCLB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adderCLB.tcl -notrace
